...
2. Install the required tools:
    ...
    + [TypeScript](https://www.typescriptlang.org) After installation
    ...
    + [esbuild](https://esbuild.github.io) After installation, make a symbolic link
    ...
    + `src` – contains source code
        ...
        + `docs` – contains sources for documentation. Large variety of file types.
            ...
            + `doc_start.md` Typedoc transforms this to be the documentation
                "home page" file `build/docs/index.html`
...
[SimRunner](./classes/lab_app_SimRunner.SimRunner.html) with English and German
strings.
...
[evaluate()](./classes/lab_engine2D_RigidBodySim.RigidBodySim.html#evaluate)
method

    evaluate(vars: number[], change: number[], _timeStep: number): null|object {

The underscore suppresses a
[TypeScript compiler warning "unused parameter"](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-0.html#flag-unused-declarations-with---nounusedparameters-and---nounusedlocals).
...
in TypeScript code (which is processed by [Typedoc](https://typedoc.org)) or is in a
markdown `.md` file (which is processed by
[MultiMarkdown](http://fletcherpenney.net/multimarkdown/)).

See [Documentation Links](Doc_Links.html) for the numerous wasy of writing links in
...
[esbuild](https://esbuild.github.io) is used to bundle and minify the JavaScript code.
...
[Typedoc](https://typedoc.org) creates documentation from TypeScript files.
The [Doc Comments](https://typedoc.org/guides/doccomments/) page describes the
particular flavor of markdown used.
