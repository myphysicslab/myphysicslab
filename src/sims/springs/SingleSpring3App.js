...
goog.module('myphysicslab.sims.springs.SingleSpring3App');
...
that this uses {@link myphysicslab.sims.common.TabLayout3} for layout.
*/
class SingleSpring3App extends AbstractApp {
/**
...
* @return {!SingleSpring3App}
*/
function makeSingleSpring3App(elem_ids) {
  return new SingleSpring3App(elem_ids);
};
goog.exportSymbol('makeSingleSpring3App', makeSingleSpring3App);

exports = SingleSpring3App;
