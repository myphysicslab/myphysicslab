...
import { AbstractApp0 } from '../common/AbstractApp.js';
...
import { TimeGraph2 } from '../common/TimeGraph2.js';
import { Util } from '../../lab/util/Util.js';

/** Displays the {@link SingleSpringSim} simulation, but with a {@link TimeGraph2}
* which displays two independent time graphs on top of each other.
*/
export class SingleSpring2App extends AbstractApp0<SingleSpringSim, TimeGraph2> implements Subject, SubjectList {
  block: DisplayShape;
...
/**
*/
makeTimeGraph(): TimeGraph2 {
  return new TimeGraph2(this.sim.getVarsList(), this.layout.getTimeGraphCanvas(),
