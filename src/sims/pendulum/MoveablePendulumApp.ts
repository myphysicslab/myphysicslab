...
import { MoveablePendulumSim } from './MoveablePendulumSim.js';
...
*/
export class MoveablePendulumApp extends AbstractApp<MoveablePendulumSim> implements Subject, SubjectList {
  anchor: DisplayShape;
  rod: DisplayLine;
  bob: DisplayShape;
...
constructor(elem_ids: ElementIDs) {
  ...
  const sim = new MoveablePendulumSim();
  ...
  let pn = sim.getParameterNumber(MoveablePendulumSim.en.LENGTH);
...
Util.defineGlobal('sims$pendulum$MoveablePendulumApp', MoveablePendulumApp);
