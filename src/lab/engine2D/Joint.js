...
*/
Joint.addSingleFixedJoint = function(sim, body, attach_body, normalType, normal) {
  return Joint.addSingleJoint(sim,
...
@return {!Joint} the Joint that is created
*/
Joint.addSingleJoint = function(sim, body1, attach1_body, body2, attach2_body,
    normalType, normal) {
  var j1 = new Joint(
      body1, attach1_body,
      body2, attach2_body,
...
@param {!CoordType} normalType whether the normal should be in
    body or world coords, from {@link myphysicslab.lab.model.CoordType}.
*/
Joint.attachFixedPoint = function(sim, body, attach_body, normalType) {
...
@param {!CoordType} normalType whether the normal should be in
    body or world coords, from {@link myphysicslab.lab.model.CoordType}.
*/
Joint.attachRigidBody = function(sim, body1, attach1_body, body2, attach2_body,
    normalType) {
  Joint.addSingleJoint(sim,
      body1, attach1_body,
      body2, attach2_body,
