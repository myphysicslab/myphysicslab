...
goog.module('myphysicslab.lab.util.test.DoubleRectTest');
...
static test() {
  schedule(DoubleRectTest.testDoubleRect);
};

static testDoubleRect() {
  startTest(DoubleRectTest.groupName+'testDoubleRect');
...
* @const
*/
DoubleRectTest.groupName = 'DoubleRectTest.';

exports = DoubleRectTest;
