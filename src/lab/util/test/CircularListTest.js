...
goog.module('myphysicslab.lab.util.test.CircularListTest');
...
static test() {
  schedule(CircularListTest.testUtilCircularList1);
  schedule(CircularListTest.testUtilCircularList2);
  schedule(CircularListTest.testUtilCircularList3);
};
...
static testUtilCircularList2() {
  startTest(CircularListTest.groupName+'testUtilCircularList2');
...
static testUtilCircularList3() {
  startTest(CircularListTest.groupName+'testUtilCircularList3');
  /** @type {!HistoryList<!Vector>}*/
...
* @const
*/
CircularListTest.groupName = 'CircularListTest.';

exports = CircularListTest;
