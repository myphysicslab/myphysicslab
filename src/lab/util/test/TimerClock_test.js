...
myphysicslab.lab.util.test.TimerClock_test.MockClass.prototype.myCallBack = function() {
  ...
  assertRoughlyEquals(Util.systemTime(), this.timer.getExpectedTime(), 1E-6);
...
var testTimerClock3 = function() {
  ...
  try {
    ...
    assertRoughlyEquals(0.160, Util.systemTime(), tol);
    assertEquals(1, mockObsvr1.numEvents);
    assertEquals(3, myMockClass.timesFired);
    ...
    mockClock.tick(30);
    assertRoughlyEquals(0.190, Util.systemTime(), tol);
    assertEquals(4, myMockClass.timesFired);
    ...
    mockClock.setTimeoutDelay(-10);
    mockClock.tick(40);
    assertRoughlyEquals(0.290, Util.systemTime(), tol);
    assertEquals(6, myMockClass.timesFired);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(70);
    assertRoughlyEquals(0.360, Util.systemTime(), tol);
    assertEquals(7, myMockClass.timesFired);
    ...
    mockClock.tick(50);
    assertRoughlyEquals(0.450, Util.systemTime(), tol);
    ...
    mockClock.tick(45);
    assertRoughlyEquals(0.495, Util.systemTime(), tol);
    ...
    mockClock.setTimeoutDelay(-5);
    mockClock.tick(45);
    assertRoughlyEquals(0.540, Util.systemTime(), tol);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(70);
    assertRoughlyEquals(0.610, Util.systemTime(), tol);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(40);
    assertRoughlyEquals(0.650, Util.systemTime(), tol);
...
var testTimerClock4 = function() {
  ...
  try {
    ...
    mockClock.setTimeoutDelay(-5);
    mockClock.tick(40);
    assertRoughlyEquals(0.535, Util.systemTime(), tol);
    assertEquals(11, myMockClass.timesFired);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(60);
    assertRoughlyEquals(0.595, Util.systemTime(), tol);
    assertEquals(12, myMockClass.timesFired);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(50);
    assertRoughlyEquals(0.645, Util.systemTime(), tol);
    assertEquals(13, myMockClass.timesFired);
    ...
    mockClock.setTimeoutDelay(10);
    mockClock.tick(50);
    assertRoughlyEquals(0.695, Util.systemTime(), tol);
