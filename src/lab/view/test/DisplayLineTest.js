...
goog.module('myphysicslab.lab.view.test.DisplayLineTest');
...
static test() {
  schedule(DisplayLineTest.testDisplayLine);
};

/** @suppress {invalidCasts} */
static testDisplayLine() {
  startTest(DisplayLineTest.groupName+'testDisplayLine');
  var tol = 1E-14;
...
* @const
*/
DisplayLineTest.groupName = 'DisplayLineTest.';

exports = DisplayLineTest;
