...
goog.module('myphysicslab.lab.view.test.CoordMapTest');
...
static test() {
  schedule(CoordMapTest.testCoordMap);
};

static testCoordMap() {
  startTest(CoordMapTest.groupName+'testCoordMap');
  var tol = 1E-13;
  // WIDE screen rect
...
* @const
*/
CoordMapTest.groupName = 'CoordMapTest.';

exports = CoordMapTest;
