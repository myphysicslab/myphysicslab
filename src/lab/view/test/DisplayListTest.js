...
static test() {
  schedule(DisplayListTest.testDisplayList);
};

static testDisplayList() {
  startTest(DisplayListTest.groupName+'testDisplayList');
  var tol = 1E-14;
...
* @const
*/
DisplayListTest.groupName = 'DisplayListTest.';

exports = DisplayListTest;
