...
size as simulation coordinates. See [Body Coordinates](Engine2D.html#bodycoordinates),
and {@link MassObject}.
...
The above examples of using an {@link AffineTransform} on an image were generated by
altering the application {@link myphysicslab.sims.engine2D.DoublePendulum2App}.
...
class DisplayShape {
/**
* @param {?MassObject=} massObject the MassObject to display
* @param {?DisplayShape=} proto the prototype DisplayShape to inherit properties from
*/
